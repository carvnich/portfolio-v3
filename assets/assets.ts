...
export const projects: Project[] = [
    {
        ...
        stack: [
            ...
            { name: "typescript", color: "text-purple-600" },
    ...
    },
    {
        ...
        stack: [
            ...
            { name: "express", color: "text-orange-500" },
            { name: "react", color: "text-blue-500" },
    ...
    {
        id: "otsl",
        title: "Old Timers Soccer League",
        src: "/otsl.png",
        alt: "old timers soccer league",
        bgColor: "bg-green-300",
        stack: [
            // { name: "sql server", color: "text-green-500" },
            { name: "asp.net", color: "text-orange-500" },
            { name: "c#", color: "text-lime-600" },
            { name: "javascript", color: "text-purple-600" },
            { name: "bootstrap", color: "text-pink-500" },
        ],
        href: "http://carvnich-001-site1.mtempurl.com/",
        github: "https://github.com/carvnich/OldTimersSoccer",
    ...
    },
    {
        ...
        stack: [
            { name: "nextjs", color: "text-orange-500" },
            { name: "react", color: "text-blue-500" },
            { name: "javascript", color: "text-purple-600" },
            { name: "tailwind", color: "text-pink-500" },
        ],
    ...
    },
    {
        ...
        stack: [
            { name: "react router", color: "text-blue-500" },
            { name: "typescript", color: "text-purple-600" },
            { name: "tailwind", color: "text-pink-500" },
        ],
